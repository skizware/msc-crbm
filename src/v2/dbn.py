...
class AbstractDbn(object):
    ...
    def __init__(self, first_layer=None, saved_state=None):
        if first_layer is not None:
            ...
            raise NotImplementedError("Not yet implemented. Must provide initial layer")
    ...
    def add_layer(self, new_layer_output_shape, learning_rate=0.01, target_sparsity=0.1, sparsity_learning_rate=0.1):
        layer = self.__create_next_layer(new_layer_output_shape, learning_rate, target_sparsity, sparsity_learning_rate)
        self.layers.append(layer)

    # @abstractmethod
    def __create_next_layer(self, new_layer_output_shape, learning_rate, target_sparsity, sparsity_learning_rate):
