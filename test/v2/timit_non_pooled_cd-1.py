...
DIR_OUT_RESULTS = 'timit_batch_64_non_pooled_cd1/results2/'
#starting_dbn = dbn.GaussianVisibleDbn()
starting_dbn = dbn.DbnFromStateBuilder.init_dbn(np.load('/home/dave/code/msc-crbm/test/v2/timit_batch_64_non_pooled_cd1/results/layer_0/lr_0.005_st_0.03_slr_0.9/dbn_state_6572.npy').item())
